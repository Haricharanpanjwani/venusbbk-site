  ...
  galleryItems: [
    {
      ...
      caption: "A full view of the banquet hall with the stage, seating, and overall event scale.",
    },
    {
      ...
      caption: "The stage-facing setup shows how the hall works for ceremonies, receptions, and performances.",
    },
    {
      title: "Banquet Seating Perspective",
      category: "banquet",
      image: "venus-hall-table.jpeg",
      alt: "Banquet seating and table setup inside Venus Club",
      caption: "An interior angle that highlights table styling, guest seating, and event layout.",
    },
    {
      title: "Lounge & Hall View",
      category: "banquet",
      image: "venus-hall-lounge.jpeg",
      alt: "Lounge seating inside the banquet hall at Venus Club",
      caption: "The hall also supports lounge seating and flexible layouts for hosted celebrations.",
    },
    {
      title: "Venue Facade",
      category: "outdoor",
      image: "venus-exterior-facade.jpeg",
      alt: "Front exterior of Venus Club and Banquet",
      caption: "The exterior facade gives the venue a strong and polished first impression.",
    },
    {
      title: "Decorated Entrance",
      category: "outdoor",
      image: "venus-entrance-floral.jpeg",
      alt: "Decorated entrance installation at Venus Club for weddings and receptions",
      caption: "A floral entrance setting that shapes guest arrival and welcome photographs.",
    },
    {
      title: "Welcome Arch",
      category: "outdoor",
      ...
      caption: "An arrival arch that works beautifully for wedding and reception entry moments.",
    },
    {
      title: "Outdoor Decor Tree",
      category: "outdoor",
      image: "venus-decor-tree.jpeg",
      alt: "Decorated outdoor tree with hanging lanterns at Venus Club",
      caption: "A smaller outdoor styling detail that adds charm to evening celebrations.",
    },
    {
      ...
      caption: "The interior circulation areas feel clean, warm, and ready for guest movement.",
    },
    {
    ...
    },
    {
      ...
      caption: "A close look at the venue identity and entrance branding on site.",
    },
    {
      title: "Family Event Lawn",
      category: "social",
      image: "venus-family-lawn.jpeg",
      alt: "Family activity setup on the lawn at Venus Club",
      caption: "The lawn can also support lighter family-focused setups and day events.",
    },
  ],
};
